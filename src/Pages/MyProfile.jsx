          ...
          <form onSubmit={handleProfileUpdate} className="space-y-7">
            <div className="flex flex-col items-center gap-6 mb-8">
              <div className="avatar">
                <div className="w-36 h-36 rounded-full ring-4 ring-primary ring-offset-base-100 ring-offset-2 overflow-hidden shadow-lg transition-transform duration-300 hover:scale-105">
                  <img
            ...
            <div className="form-control">
              <label className="label">
                <span className="label-text text-base-content font-semibold text-base">
                  Your Name
                </span>
              </label>
              <label className="input input-bordered flex items-center gap-3 bg-base-200 focus-within:border-primary">
                <FaUser className="text-base-content/60 text-xl" />
                <input
                  type="text"
                  name="displayName"
                  className="grow outline-none bg-transparent text-base-content text-base"
                  value={displayName}
            ...
            <div className="form-control">
              ...
              <label className="input input-bordered flex items-center gap-3 bg-base-200 focus-within:border-primary">
                <FaImage className="text-base-content/60 text-xl" />
                <input
                  type="url"
                  name="photoURL"
                  className="grow outline-none bg-transparent text-base-content text-base"
